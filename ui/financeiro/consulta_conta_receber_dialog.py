...
class Ui_ConsultaContaReceberDialog(object):
    def setupUi(self, ConsultaContaReceberDialog):
        ...
        self.frameItens = QtWidgets.QFrame(ConsultaContaReceberDialog)
        ...
        self.lblItens.setStyleSheet("background-color:#f0f6fc;color:#1a3a5c;font-size:13px;font-weight:bold;padding:8px 12px;border-bottom:1px solid #d8e3ee;")
        ...
        self.tableItens.setColumnCount(4)
        self.tableItens.setObjectName("tableItens")
        item = QtWidgets.QTableWidgetItem()
        self.tableItens.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableItens.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableItens.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableItens.setHorizontalHeaderItem(3, item)
    ...
    def retranslateUi(self, ConsultaContaReceberDialog):
        ...
        self.lblItens.setText(_translate("ConsultaContaReceberDialog", "Itens da Venda"))
        item = self.tableItens.horizontalHeaderItem(0)
        item.setText(_translate("ConsultaContaReceberDialog", "Codigo"))
        item = self.tableItens.horizontalHeaderItem(1)
        item.setText(_translate("ConsultaContaReceberDialog", "Produto"))
        item = self.tableItens.horizontalHeaderItem(2)
        item.setText(_translate("ConsultaContaReceberDialog", "Qtd"))
        item = self.tableItens.horizontalHeaderItem(3)
        item.setText(_translate("ConsultaContaReceberDialog", "Subtotal"))
