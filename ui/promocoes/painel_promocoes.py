...
class Ui_PainelPromocoes(object):
    def setupUi(self, PainelPromocoes):
        ...
        self.tablePromocoes.setColumnCount(7)
        ...
        self.tablePromocoes.horizontalHeader().setDefaultSectionSize(130)
        self.tablePromocoes.horizontalHeader().setMinimumSectionSize(70)
    ...
    def retranslateUi(self, PainelPromocoes):
        ...
        self.cmbTipoFiltro.setItemText(4, _translate("PainelPromocoes", "Leve X Pague Y"))
        self.cmbTipoFiltro.setItemText(5, _translate("PainelPromocoes", "Desconto progressivo"))
        self.cmbTipoFiltro.setItemText(6, _translate("PainelPromocoes", "Combo"))
        ...
        item.setText(_translate("PainelPromocoes", "Regra"))
        item = self.tablePromocoes.horizontalHeaderItem(6)
        item.setText(_translate("PainelPromocoes", "Produtos"))
