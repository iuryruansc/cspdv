...
class Ui_PainelPromocoes(object):
    def setupUi(self, PainelPromocoes):
        ...
        self.tablePromocoes.setColumnWidth(1, 220)
        self.tablePromocoes.setColumnWidth(2, 140)
        self.tablePromocoes.setColumnWidth(3, 420)
        self.tablePromocoes.setColumnWidth(4, 95)
        self.tablePromocoes.setColumnWidth(5, 130)
